...
function getNoticias($chatId, $noticia){
    ...
    $titulo1 = $titulo1."\n\n".$array['channel']['title']."<a href='".$array['channel']['description']['1']['link']."'> +info</a>";
    $titulo2 = $titulo2."\n\n".$array['channel']['title']."<a href='".$array['channel']['description']['2']['link']."'> +info</a>";
    $titulo3 = $titulo3."\n\n".$array['channel']['title']."<a href='".$array['channel']['description']['3']['link']."'> +info</a>";
